$(function() {
  ...
  Quagga.onDetected(function(result) {
    ...
    if (App.lastResult !== code) {
      ...
      $node = $(
        `<li><div class="thumbnail"><div class="imgWrapper"><img /></div><div class="caption"><h4 class="code"></h4></div><form action='/charge'><input type="text" name="data" value='' id='data-input-field'><br><input type="submit" value="Submit"></form></div></li>`
      );
      $node.find('img').attr('src', canvas.toDataURL());
      $node.find('h4.code').html(code);
      $('#result_strip ul.thumbnails').prepend($node);
      $node.find('input#data-input-field').val(code);
    }
  });
});